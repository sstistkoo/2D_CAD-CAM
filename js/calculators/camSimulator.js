...
// getNormal, vecAngle, normalizeAngle → přesunuto do cam/camMath.js
...
// intersectLineCircle → přesunuto do cam/camMath.js
...
// _locateOnContour → přesunuto do cam/camMath.js
...
// buildHolderBoundaryPts, guidePolyPoints, guideBridgePts, mkBridgeSegs
// → přesunuto do cam/interferenceGuides.js (guidePolyPoints/guideBridgePts/
//   mkBridgeSegs se importují zpět, používá je buildMachinableContour níže).
...
// camRayIntersection, computeInterferenceGuides → přesunuto do
// cam/interferenceGuides.js (importují se zpět). camRayIntersection používá
// i buildMachinableContour náběhy / interaktivní mezní čáry níže.
...
// getArcParams, isAngleBetween, intersectHorizontalLineSegment → přesunuto do cam/camMath.js
