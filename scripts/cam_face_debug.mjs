...
export { resolvePointsToAbsolute, getArcParams, getNormal, foldContourToMachiningSide,
  ...
  removeContourSelfIntersections, buildMachinableContour, dropTinyArcs,
...
function buildSegs(wp) {
  ...
  for (let i = 0; i < wp.length - 1; i++) {
    ...
    if (type === 'G1') segs.push({ type:'line', p1:{x:p1.xReal,z:p1.zReal}, p2:{x:p2.xReal,z:p2.zReal}, orig:p2 });
      ...
      segs.push({ type:'arc', ...arc, p1:{x:p1.xReal,z:p1.zReal}, p2:{x:p2.xReal,z:p2.zReal}, dir:type, startAngle, endAngle });
    }
  }
  return segs;
}
