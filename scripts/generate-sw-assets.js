...
const IGNORE = new Set(['node_modules', 'tests', 'scripts', '.git', '.vscode', '.claude', '.kilo', 'test.dxf', 'vitest.config.js', 'package.json', 'package-lock.json', 'skica.code-workspace', 'sw.js']);
